...
DATABASES = {
    "default": {
        ...
        "USER": config("POSTGRES_USER", default="ecommerce"),
        "PASSWORD": config("POSTGRES_PASSWORD", default="ecommerce"),
...
if USE_S3:
    ...
    AWS_STORAGE_BUCKET_NAME = config("AWS_STORAGE_BUCKET_NAME", default="ecommerce-media")
